...
declare type EAIState = 'Idle' | 'Suspicious' | 'Alerted' | 'EAIState_MAX';
declare var EAIState : { Idle:'Idle',Suspicious:'Suspicious',Alerted:'Alerted',EAIState_MAX:'EAIState_MAX', };
declare class FPSAIGuard extends Character { 
	PawnSensingComponent: PawnSensingComponent;
	GuardState: EAIState;
	bPatrol: boolean;
	FirstPatrolPoint: Actor;
	SecondPatrolPoint: Actor;
	static GetDefaultObject(): FPSAIGuard;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSAIGuard;
	ResetOrientation(): void;
	OnStateChanged(NewState: EAIState): void;
	OnRep_GuardState(): void;
	OnPawnSeen(SeenPawn: Pawn): void;
	OnNoiseHeard(NoiseInstigator: Pawn,Location: Vector,Volume: number): void;
	static C(Other: UObject | any): FPSAIGuard;
}

declare class FPSBlackHoleActor extends Actor { 
	MeshComp: StaticMeshComponent;
	InnerSphereComp: SphereComponent;
	OuterSphereComp: SphereComponent;
	static GetDefaultObject(): FPSBlackHoleActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSBlackHoleActor;
	OverlapInnerSphere(OverlappedComponent: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,OtherBodyIndex: number,bFromSweep: boolean,SweepResult: HitResult): void;
	static C(Other: UObject | any): FPSBlackHoleActor;
}

declare class FPSProjectile extends Actor { 
	CollisionComp: SphereComponent;
	ProjectileMovement: ProjectileMovementComponent;
	static GetDefaultObject(): FPSProjectile;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSProjectile;
	OnHit(HitComp: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,NormalImpulse: Vector,Hit: HitResult): void;
	static C(Other: UObject | any): FPSProjectile;
}

declare class FPSCharacter extends Character { 
	Mesh1PComponent: SkeletalMeshComponent;
	GunMeshComponent: SkeletalMeshComponent;
	CameraComponent: CameraComponent;
	NoiseEmitterComponent: PawnNoiseEmitterComponent;
	ProjectileClass: UnrealEngineClass;
	FireSound: SoundBase;
	FireAnimation: AnimSequence;
	bIsCarryingObjective: boolean;
	static GetDefaultObject(): FPSCharacter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSCharacter;
	ServerFire(): void;
	static C(Other: UObject | any): FPSCharacter;
}

declare class FPSExtractionZone extends Actor { 
	OverlapComp: BoxComponent;
	DecalComp: DecalComponent;
	ObjectiveMissingSound: SoundBase;
	static GetDefaultObject(): FPSExtractionZone;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSExtractionZone;
	HandleOverlap(HitComp: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,OtherBodyIndex: number,bFromSweep: boolean,SweepResult: HitResult): void;
	static C(Other: UObject | any): FPSExtractionZone;
}

declare class FPSGameMode extends GameModeBase { 
	SpectatingViewpointClass: UnrealEngineClass;
	static GetDefaultObject(): FPSGameMode;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSGameMode;
	OnMissionCompleted(InstigatorPawn: Pawn,bMissionSuccess: boolean): void;
	static C(Other: UObject | any): FPSGameMode;
}

declare class FPSGameState extends GameStateBase { 
	static GetDefaultObject(): FPSGameState;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSGameState;
	MulticastOnMissionComplete(InstigatorPawn: Pawn,bMissionSuccess: boolean): void;
	static C(Other: UObject | any): FPSGameState;
}

declare class FPSHUD extends HUD { 
	static GetDefaultObject(): FPSHUD;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSHUD;
	static C(Other: UObject | any): FPSHUD;
}

declare class FPSLaunchPad extends Actor { 
	MeshComp: StaticMeshComponent;
	OverlapComp: BoxComponent;
	LaunchStrenght: number;
	LaunchPitchingAngle: number;
	ActivateLaunchPadEffect: ParticleSystem;
	static GetDefaultObject(): FPSLaunchPad;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSLaunchPad;
	OverlapLaunchPad(HitComp: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,OtherBodyIndex: number,bFromSweep: boolean,SweepResult: HitResult): void;
	static C(Other: UObject | any): FPSLaunchPad;
}

declare class FPSObjectiveActor extends Actor { 
	MeshComp: StaticMeshComponent;
	SphereComp: SphereComponent;
	PickupFX: ParticleSystem;
	static GetDefaultObject(): FPSObjectiveActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSObjectiveActor;
	static C(Other: UObject | any): FPSObjectiveActor;
}

declare class FPSPlayerController extends PlayerController { 
	static GetDefaultObject(): FPSPlayerController;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FPSPlayerController;
	OnMissionCompleted(InstigatorPawn: Pawn,bMissionSuccess: boolean): void;
	static C(Other: UObject | any): FPSPlayerController;
}

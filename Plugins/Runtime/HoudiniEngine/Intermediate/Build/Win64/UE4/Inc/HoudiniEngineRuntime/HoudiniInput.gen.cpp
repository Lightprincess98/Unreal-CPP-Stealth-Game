...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bSwitchedToCurve_MetaData[];
#endif
		static void NewProp_bSwitchedToCurve_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSwitchedToCurve;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bLandscapeHasExportTypeChanged_MetaData[] = {
		{ "Comment", "// ?? TArray<FHoudiniInputLandscape> LandscapeInputObjects;\n" },
		{ "ModuleRelativePath", "Private/HoudiniInput.h" },
		{ "ToolTip", "?? TArray<FHoudiniInputLandscape> LandscapeInputObjects;" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve_MetaData[] = {
		{ "Comment", "// Is set to true when choice switches to curve mode.\n" },
		{ "ModuleRelativePath", "Private/HoudiniInput.h" },
		{ "ToolTip", "Is set to true when choice switches to curve mode." },
	};
#endif
	void Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve_SetBit(void* Obj)
	{
		((UHoudiniInput*)Obj)->bSwitchedToCurve = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve = { "bSwitchedToCurve", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInput), &Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniInput_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniInput_Statics::NewProp_bSwitchedToCurve,
	...
	IMPLEMENT_CLASS(UHoudiniInput, 1058684661);

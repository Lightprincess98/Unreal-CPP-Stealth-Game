...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_HoudiniEngine_EPackageReplaceMode_Hash() { return 3601928901U; }
	...
	uint32 Get_Z_Construct_UEnum_HoudiniEngine_EPackageMode_Hash() { return 1880899714U; }
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPackageParams
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAttemptToLoadMissingPackages_MetaData[];
#endif
		static void NewProp_bAttemptToLoadMissingPackages_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAttemptToLoadMissingPackages;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages_MetaData[] = {
		{ "Comment", "// If FindPackage returns null, if this flag is true then a LoadPackage will also be attempted\n// This is for use cases, such as commandlets, that might unload packages once done with them, but that must\n// reliably be able to determine if a package exists later\n" },
		{ "ModuleRelativePath", "Private/HoudiniPackageParams.h" },
		{ "ToolTip", "If FindPackage returns null, if this flag is true then a LoadPackage will also be attempted\nThis is for use cases, such as commandlets, that might unload packages once done with them, but that must\nreliably be able to determine if a package exists later" },
	};
#endif
	void Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages_SetBit(void* Obj)
	{
		((FHoudiniPackageParams*)Obj)->bAttemptToLoadMissingPackages = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages = { "bAttemptToLoadMissingPackages", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FHoudiniPackageParams), &Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewProp_bAttemptToLoadMissingPackages,
	...
	uint32 Get_Z_Construct_UScriptStruct_FHoudiniPackageParams_Hash() { return 1505920515U; }
